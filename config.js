...
module.exports = {
  ...
  organ: {
    name: process.env.SPINAL_ORGAN_NAME || "Organ ticket ServiceNow",
    configPath: process.env.SPINAL_CONFIG_PATH || "/etc/Organs/ticket"
  },
  apiBaseURI : "https://saintgobainssctest.service-now.com"
};
